            ...
            if (!id.equals("") && id != null && newValueStr != null) {
                ...
                if (newValue) {
                    out.print("<!-- Activate Confirm Model content -->\n"
                            ...
                            + "        <div class=\"row\">\n"
                            + "            <div class=\"col\">\n"
                            + "                <p class=\"m-0 fs-5 fw-normal\">Product <span class=\"fw-bold\">" + id + "</span> activated !</p>\n"
                            + "            </div>\n"
                            + "        </div>\n"
                            + "    </div>\n"
                            + "</div>\n"
                    ...
                    out.print("<!-- Inactivate Confirm Model content -->\n"
                            ...
                            + "        <div class=\"row\">\n"
                            + "            <div class=\"col\">\n"
                            + "                <p class=\"m-0 fs-5 fw-normal\">Product <span class=\"fw-bold\">" + id + "</span> inactivated !</p>\n"
                            + "            </div>\n"
                            + "        </div>\n"
                            + "    </div>\n"
                            + "</div>\n"
