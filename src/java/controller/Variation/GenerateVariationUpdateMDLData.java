...
public class GenerateVariationUpdateMDLData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!variationId.equals("") && variationId != null) {
                ...
                data.put("variationId", String.valueOf(variation.getId()));
                data.put("variationName", variation.getName());
                ...
                for (ProductCategory productCategory : catagoryList) {
                    if (productCategory.getId().equals(variation.getProductCategory().getId())) {
