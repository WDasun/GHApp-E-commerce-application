...
import controller.Login.EmployeeLogin;
...
public class EmployeeLogout extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            new CreateLog("info", "Employee system Logout.", currentEmployee.getEmployeeId(), EmployeeLogin.class.getName()).employeeActivey();
            
            request.getSession().invalidate();

            JsonObject jsonResponse = new JsonObject();
            jsonResponse.addProperty("redirect", true);
            jsonResponse.addProperty("redirectUrl", request.getContextPath() + "/EmployeeLogin.jsp");
